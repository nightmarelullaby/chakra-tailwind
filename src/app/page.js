...
export default function Home() {
  ...
  <Center className="h-full p-4 dark:bg-gray-950">
    ...
    <Stack gap="4">
      <Heading className="dark:text-gray-300 text-red font-bold text-gray-800 text-4xl text-center" as="h1">
    ...
    <Box>
      <Heading as="h3" className="dark:text-gray-300 text-lg font-bold mb-4 text-gray-700" size="md">¿Qué ventajas nos ofrecería trabajar con ambas librerías?</Heading>
      <UnorderedList>
      ...
      <Heading className="dark:text-gray-300 mb-4 mt-4 text-lg font-bold text-gray-700" size="md">¿Qué desventajas podría presentar?</Heading>
      <UnorderedList>
        <ListItem className="dark:text-gray-400" >
    ...
    <Heading as="h3" className="dark:text-gray-300 text-lg font-bold mb-1 text-gray-700" size="md">Prueba aquí abajo los componentes!</Heading>
    <Stack direction="column" gap="6">
    ...
    <Stack direction="row" gap="6">
      <Stack>
        ...
        <Text as="small" className="dark:text-gray-400">Button with Tailwind Styles</Text>
      </Stack>
      <Stack >
      <Button variant="outline">
        Secondary Button
      </Button>
      <Text as="small" className="dark:text-gray-400" >Button with default Chakra Styles</Text>
      </Stack>
    ...
    <Menu>
      ...
      <Text as="small" className="dark:text-gray-400" >Menu with Talwind CSS</Text>
    </Stack>
    
    <Stack className="items-start">
      <Button onClick={onOpen} className="dark:text-gray-200">Open Modal</Button>
    ...
    <Text as="small" className="dark:text-gray-400">Modal with some tailwind styles</Text>
    </Stack>
    </Stack>
    <Box>
